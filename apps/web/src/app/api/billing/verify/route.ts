...
import { razorpayEnvPresence, razorpayKeySecret } from '@/lib/server-env';
    ...
    return NextResponse.json(
      {
        ...
        hint:
          'Set RAZORPAY_KEY_SECRET or RAZORPAY_SECRET on the **Next.js** server environment and redeploy.',
      },
      { status: 500 }
    );
  }
