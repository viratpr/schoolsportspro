/**
 * This file defines the "Pricing" page for the SchoolSportsPro marketing website.
 * 
 * Key Features:
 ...
 *    2. Tournament Pass: Paid (USD for 3 months), includes certificate generation and full tournament coverage.
 *    3. Annual Pro: Paid (USD for 12 months), highlighted as "Best value" with additional benefits such as a public live score URL, certificates, global ranking, and priority support.
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <p className="text-center text-muted-foreground max-w-xl mx-auto mb-12">
        Start with a free trial. No card required. Paid plans are billed in USD through Stripe.
      </p>
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-3xl font-bold mt-2">
              {formatUsdFromCents(centsForPlan('TOURNAMENT_PASS'))}{' '}
