...
**Sport-specific scorecards.** Each sport (baseball, soccer, basketball, volleyball, wrestling, etc.) has a template: the right fields for that game. You enter scores (and optionally player stats); the system computes summaries and who won. No more guessing which spreadsheet column to use.
